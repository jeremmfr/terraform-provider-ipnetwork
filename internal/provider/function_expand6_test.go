...
func TestAccFunctionExpand6(t *testing.T) {
	t.Parallel()
	...
	tests := map[string]testCase{
		...
		"address_cidr_ipv6": {
			input:  "2001:db8::1/64",
			output: "2001:0db8:0000:0000:0000:0000:0000:0001/64",
		},
		"address_0_ipv6": {
			input:  "::",
		...
		"address_scoped": {
			...
			output: "fe80:0000:0000:0000:1cc0:3e8c:119f:c2e1%ens18",
		},
	}
					...
					Steps: []resource.TestStep{
						{
							Config: `
							output "test" {
								value = provider::ipnetwork::expand6("` + test.input + `")
							}
							`,
